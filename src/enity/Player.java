...
public class Player {
    ...
    public Player(String s, LocalDate of, String batsman, String male, String countryA) {
        this.name = s;
    }
    ...
    public Player(String name, LocalDate dateOfBirth, String specialization, String gender, String country, Integer playedMatches, Long runs, Long wickets, Integer highScore, Double strikeRate, Integer numberOf50s, Integer numberOf100s, boolean isOut) {
        this.name = name;
